...
if ( ! function_exists( 'cgs_module_help_enabled' ) ) {
    /**
     * @return bool
     */
    function cgs_module_help_enabled() {
        ...
        return ! empty( $flags['help'] );
    }
}

if ( ! cgs_module_help_enabled() ) {
    return;
}
...
if ( defined( 'WP_DEBUG' ) && WP_DEBUG ) {
    // error_log( '[CGS] module help ready' );
}
